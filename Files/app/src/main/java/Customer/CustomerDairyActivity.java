...
public class CustomerDairyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_dairy);
        ...
        Query query = FirebaseDatabase.getInstance().getReference("users").child("retailer").child("Dairy");
