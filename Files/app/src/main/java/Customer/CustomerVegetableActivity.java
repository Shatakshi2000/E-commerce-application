...
public class CustomerVegetableActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_vegetable);
        ...
        Query query = FirebaseDatabase.getInstance().getReference("users").child("retailer").child("Vegetables");
