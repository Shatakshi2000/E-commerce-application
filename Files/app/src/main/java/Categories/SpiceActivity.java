...
public class SpiceActivity extends AppCompatActivity {
    ...
    androidx.appcompat.widget.Toolbar spicesToolbar;
    Button AddSpices;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spicesToolbar = (Toolbar) findViewById(R.id.spices_toolbar);
        setSupportActionBar(spicesToolbar);
        getSupportActionBar().setDisplayShowTitleEnabled(false);

        recyclerView = findViewById(R.id.recview);
        AddSpices = (Button) findViewById(R.id.add_spices);
        ...
        Query query = FirebaseDatabase.getInstance().getReference("users").child("wholesaler").child("Spices")
                    ...
                    public void onClick(View v) {
                        ...
                        buttonUpdate.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                FirebaseDatabase.getInstance().getReference("users").child("wholesaler").child("Spices")
        ...
        AddSpices.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
