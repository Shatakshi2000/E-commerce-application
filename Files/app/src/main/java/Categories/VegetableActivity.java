...
public class VegetableActivity extends AppCompatActivity {
    ...
    androidx.appcompat.widget.Toolbar vegetablesToolbar;
    Button AddVegetables;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vegetablesToolbar = (Toolbar) findViewById(R.id.fruits_toolbar);
        setSupportActionBar(vegetablesToolbar);
        getSupportActionBar().setDisplayShowTitleEnabled(false);

        recyclerView = findViewById(R.id.recview);
        AddVegetables = (Button) findViewById(R.id.vegetable_button);
        ...
        Query query = FirebaseDatabase.getInstance().getReference("users").child("wholesaler").child("Vegetables")
                    ...
                    public void onClick(View v) {
                        ...
                        buttonUpdate.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                FirebaseDatabase.getInstance().getReference("users").child("wholesaler").child("Vegetables")
        ...
        AddVegetables.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intent=new Intent(getApplicationContext(), AddNewProduct.class);
                intent.putExtra("message_key","Vegetables");// putExtra() is used for sending the data, in the key and the value can be float, string etc.
