...
import com.example.foodstuff.ManageOTP;
...
public class FruitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        AddFruit = (Button) findViewById(R.id.add_fruits);
        ...
        Query query = FirebaseDatabase.getInstance().getReference("users").child("wholesaler").child("Fruits")
