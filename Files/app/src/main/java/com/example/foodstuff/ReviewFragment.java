...
public class ReviewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = v.findViewById(R.id.review_recview);
        ...
        adapter = new FirebaseRecyclerAdapter<ReviewModel, ReviewProductHolder>(options) {

            @Override
            public ReviewProductHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            @Override
            protected void onBindViewHolder(ReviewProductHolder holder, int position, ReviewModel model) {
                // Bind the Chat object to the ChatHolder
                // ...


                holder.ratings.setRating(Float.parseFloat(model.getRatings()));
